...
<div class="tablas-listado" id="contenido">
    ...
    <form method="post" class="form-alta-serv">
        <table class="tabla-alta-serv"> 
            ...
            <tr>
                <td class="titulo">
                    <p class="derecha">Fecha Inicio : </p>
                </td>
                <td class=input>
                   <input type="datetime-local" value="<?php echo date('Y-m-d\TH:i');?>" name="fecha_inicio">
                </td>
                <td class="titulo">
                    <p class="derecha">Fecha Termino : </p>
                </td>
                <td class="input">
                    <input type="datetime-local" value="<?php echo date('Y-m-d\TH:i');?>" name="fecha_termino">
                </td>
            </tr>
            <tr>
                <td class="titulo">
...
ini_set('error_reporting', E_ALL);
    $vistaUsuario -> iniciarFinalizarServicioController();
?> 